...
class GaussianDiffusion(nn.Module):
    ...
    def ddpm_predictions(self, z_t, mask, t, *, k=1, x_self_cond = None,  class_id=None, seq2seq_cond=None, seq2seq_mask=None, sampling=False, cls_free_guidance=1.0, l2_normalize=False):
        raw_time = t*self.sampling_timesteps
        raw_time_next = (t*self.sampling_timesteps)-1
        for i in range(k):
            time = (raw_time-i)/self.sampling_timesteps
            time_next = (raw_time_next-i)/self.sampling_timesteps
