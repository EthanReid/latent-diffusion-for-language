...
if __name__ == "__main__":
    ...
    if args.eval or args.resume_training or args.eval_test:
        ...
        heldout_params = {'wandb_name', 'output_dir', 'resume_dir', 'eval', 'eval_test', 'num_samples', 'sampling_timesteps', 'sampling_schedule', 'seq2seq_candidates', 'scale', 'sampler', 'resume_training', 'save_and_sample_every', 'train_batch_size','num_train_steps','learning_rate'}
